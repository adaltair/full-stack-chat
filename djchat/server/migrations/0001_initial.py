    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to=server.models.server_banner_upload_path)),
                ('icon', models.ImageField(blank=True, null=True, upload_to=server.models.server_icon_upload_path)),
